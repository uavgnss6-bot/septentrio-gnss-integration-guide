...
- [Serial Ports, Baud Rates and Data Streams (SBF / NMEA / RTCM Configuration)](docs/serial-port-protocol-configuration.md) - port allocation, baud rates, protocol direction matrix, verification and troubleshooting
